...
Open a terminal, navigate to a folder where you would like to save the course materials, for example:
...
There will be a new directory added called `python-for-image-analysis` that contains all the course material.
